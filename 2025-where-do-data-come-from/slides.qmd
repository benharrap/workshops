...
footer: 'Slides available from [https://benharrap.github.io/workshops/2025-11-05-ARDC/slides.html](https://benharrap.github.io/workshops/2025-11-05-ARDC/slides.html)'
execute:
  code-copy: true
  echo: true
  warning: false
...
::: {.columns}
:::: {.column width=30%}
These are essential for cleaning and documentation:
...
::::: {.fragment .incremental}
Separate variables type then:

-   Check values against a series of rules
-   If a value fails a rule, do something
-   Ordering matters!
...
:::: {.column}
::::: {.r-stack}
![](img/types.svg){.fragment .fade-in-then-out height=800}

![](img/typestring.svg){.fragment .fade-in height=800}
...
## Deriving and integrating data

::: {.columns}
:::: {.column .incremental}
Standardising existing data
...
Variation in responses according to:
